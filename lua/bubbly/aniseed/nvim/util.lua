...
local _1_
do
  local name_4_auto = "bubbly.aniseed.nvim.util"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  local function _5_()
    return {autoload("bubbly.aniseed.nvim")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {nvim = "bubbly.aniseed.nvim"}}
    return val_22_auto
  else
...
local _2amodule_name_2a = "bubbly.aniseed.nvim.util"
