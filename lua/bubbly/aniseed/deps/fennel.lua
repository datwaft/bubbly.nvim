package.preload["bubbly.aniseed.fennel.repl"] = package.preload["bubbly.aniseed.fennel.repl"] or function(...)
  local utils = require("bubbly.aniseed.fennel.utils")
  local parser = require("bubbly.aniseed.fennel.parser")
  local compiler = require("bubbly.aniseed.fennel.compiler")
  local specials = require("bubbly.aniseed.fennel.specials")
...
package.preload["bubbly.aniseed.fennel.view"] = package.preload["bubbly.aniseed.fennel.view"] or function(...)
...
package.preload["bubbly.aniseed.fennel.specials"] = package.preload["bubbly.aniseed.fennel.specials"] or function(...)
  local utils = require("bubbly.aniseed.fennel.utils")
  local view = require("bubbly.aniseed.fennel.view")
  local parser = require("bubbly.aniseed.fennel.parser")
  local compiler = require("bubbly.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "bubbly.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["bubbly.aniseed.fennel.compiler"] = package.preload["bubbly.aniseed.fennel.compiler"] or function(...)
  local utils = require("bubbly.aniseed.fennel.utils")
  local parser = require("bubbly.aniseed.fennel.parser")
  local friend = require("bubbly.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["bubbly.aniseed.fennel.friend"] = package.preload["bubbly.aniseed.fennel.friend"] or function(...)
  local function ast_source(ast)
    local m = getmetatable(ast)
    return ((m and m.line and m) or (("table" == type(ast)) and ast) or {})
  end
...
package.preload["bubbly.aniseed.fennel.parser"] = package.preload["bubbly.aniseed.fennel.parser"] or function(...)
  local utils = require("bubbly.aniseed.fennel.utils")
  local friend = require("bubbly.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils = nil
package.preload["bubbly.aniseed.fennel.utils"] = package.preload["bubbly.aniseed.fennel.utils"] or function(...)
...
utils = require("bubbly.aniseed.fennel.utils")
local parser = require("bubbly.aniseed.fennel.parser")
local compiler = require("bubbly.aniseed.fennel.compiler")
local specials = require("bubbly.aniseed.fennel.specials")
local repl = require("bubbly.aniseed.fennel.repl")
local view = require("bubbly.aniseed.fennel.view")
...
do
  ...
  local module_name = "bubbly.aniseed.fennel.macros"
  local _ = nil
  local function _0_()
    return mod
  end
