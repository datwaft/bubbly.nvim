...
return function(list)
  ...
  local function render_delimiter(delimiter, color)
    if type(color) == "string" then
      ...
      return "%#"
        .. ensure_highlight_exists(gethighlight(color.foreground, color.background) .. "Delimiter")
        .. "#"
        .. delimiter
    end
  end
  ...
  for i, e in ipairs(list) do
    if e and type(e) == "table" and e.data and type(e.data) == "string" and e.data ~= "" then
      ...
      if type(e.color) == "string" then
        ...
        bubble = bubble
          .. "%#"
          .. ensure_highlight_exists(gethighlight(e.color.foreground, e.color.background, e.style))
          .. "#"
      end
      -- render data
      if not isfirst then
      ...
      if islast then
        bubble = bubble
          .. render_delimiter(e.right, e.color)
          .. "%#"
          .. ensure_highlight_exists("BubblyStatusLine")
          .. "#"
      end
      -- render post
